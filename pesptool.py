...
# in the pesptool Python package
...
if os.name != "nt":
    ...
    # as a module; we want to import the installed pesptool module instead
    ...
    # the module from scratch; this enables importing pesptool module in
    # other Python scripts
    with contextlib.suppress(KeyError):
        del sys.modules["pesptool"]
